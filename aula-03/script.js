document.addEventListener("DOMContentLoaded", function () {
  let cpfInput = document.getElementById("cpf_cnpj");
  ...
  function clearErrors() {
    ...
    document.getElementById("error_type").textContent = "";
    document.getElementById("error_cpf_cnpj").textContent = "";
  }
  ...
  function verifyCpfCnpj() {
    ...
    if (pf.checked) {
      ...
      if (!validateCpf(cpf_cnpj)) {
        document.getElementById("error_cpf_cnpj").textContent = "CPF inválido.";
        document.getElementById("cpf_cnpj").focus();
        return false;
      }
    }
